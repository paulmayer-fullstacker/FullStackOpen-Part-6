...
import { updateVoteOnServer } from '../reducers/anecdoteReducer'   // Import the updateVoteOnServer thunk.
...
const AnecdoteList = () => {
  ...
  */
  const vote = (anecdote) => {   // Increment the vote count
    dispatch(updateVoteOnServer(anecdote))   // Dispatch the thunk to handle server and local state update
    
    dispatch(setNotification(`you voted '${anecdote.content}'`, 5))   // Notification logic
